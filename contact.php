...
<div class="container pt-4">
    <div class="row no-gutters">
        <div class="col-12 hero">
            ...
            <h2 class="text-uppercase d-none d-md-block">Fale Conosco</h2>
        </div>
    </div>
</div>
...
<div class="container py-4">
      <div class="row justify-content-center">
            <main class="col-12 col-md-10 main-content">
                <h2 class="d-block d-md-none text-uppercase text-center">Fale Conosco</h2>
                ...
                <form id="contact_form" action="send.php" method="post" class="p-5 mt-5 contact-form">
                    ...
                    <input type="submit" class="btn btn-primary text-uppercase" name="submit" value="Enviar">
